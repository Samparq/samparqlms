                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group field-candidatedetails-date_of_birth required">
                                    <label class="control-label" for="candidatedetails-date_of_birth">Name <span style=color:red>*</span></label>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group field-candidatedetails-date_of_birth required">
                                    <label class="control-label" for="candidatedetails-date_of_birth">Email <span style=color:red>*</span></label>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group field-candidatedetails-gender required">
                                    <label class="control-label" for="candidatedetails-gender">Code <span style=color:red>*</span></label>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group field-candidatedetails-gender required">
                                    <label class="control-label" for="candidatedetails-gender">No of users <span style=color:red>*</span></label>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group field-candidatedetails-gender required">
                                    <label class="control-label" for="candidatedetails-gender">Cost per user <span style=color:red>*</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group field-candidatedetails-gender required">
                                    <label class="control-label" for="candidatedetails-gender">Subscription sd <span style=color:red>*</span></label>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group field-candidatedetails-gender required">
                                    <label class="control-label" for="candidatedetails-gender">Subscription ed <span style=color:red>*</span></label>
                                    <?=  $form->field($model, 'subscription_ed')->widget(DateTimePicker::classname(), [
                                        'options' => ['placeholder' => ''],
                                        'pluginOptions' => [
                                            'autoclose'=>true,
                                            'todayHighlight' => true,
