                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="mailboxsidebzr">
                                    ...
                                    <div class="alert alert-success fade in" style="background: #bce8f1; border: #bce8f1; color: #31708f">
                                        <strong>Note: </strong> Please consider bold keyword as Youtube Url ID, https://www.youtube.com/watch?v=<strong>PmFWzWbziz0</strong>
                                    </div>
