 ...
 */
class TblPostComment extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['post_id', 'comment_userid', 'comment_username', 'comment_text'], 'required'],
            [['post_id', 'comment_userid', 'comment_status', 'remove_id'], 'integer'],
            [['comment_text'], 'string'],
            [['comment_date'], 'safe'],
