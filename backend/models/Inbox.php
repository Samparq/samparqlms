...
class Inbox extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['sent_id', 'mail_from', 'flag', 'file_status', 'created_by', 'mail_to_userid'], 'integer'],
            [['message'], 'string'],
            [['mail_to','subject','message'], 'required', 'message' => 'Field can\'t be blank'],
            [['process_date','from','mail_to', 'updated_on','fileScript'], 'safe'],
