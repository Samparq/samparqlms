...
$Url='http://192.168.4.201/yiiapi/frontend/web/API/Chat_Files/';
$Url_ProImage='http://192.168.4.201/yiiapi/frontend/web/API/Upload_Files/';
if(isset($_POST['inset_chat_message'])){
	$Sender_Id=$_POST['sender_id'];
	$Receiver_Id=$_POST['receiver_id'];
	$MsgStr=str_replace("\\","\\\\",$_POST['message_str']);
...
if(isset($_POST['update_Single_chat_status'])){
	...
	if(!empty($Update_Qery)){
		$select_Receiver_id=mysql_query("select receiver_id,(select app_regid from user where id=c.sender_id)as reg_id from chat c where id='".$chat_id."'")or die(mysql_error());
